...
public class ProductoDAOList implements ProductoDAO {
    ...
    public ProductoDAOList() {
        if (productos == null) {
            ...
            productos.add(new Producto(idProducto++,"AMD RYZEN 7","imagenes/amdRyzen.jpg","AMD RYZEN 7 1700- Procesador de 3.7 GHz, Socket AM4 con ventilador Wraith Spire incluido",149.45,"Procesador"));
